    ...
    <div id='contact' className='container '>
      ...
      <div className='flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-x-8 lg:space-y-0'>
        ...
        <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
          <h2 className='text-5xl font-bold bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text mb-4'>Let&apos;s Connect</h2>
          ...
          <form ref={formRef} onSubmit={handleSubmit} action="https://getform.io/f/aejrjmpb" method='POST' className='space-y-4'>
            <div className='grid md:grid-cols-2 gap-4 '>
              <input type='firstname' name='firstName' required value={form.firstName} onChange={handleChange} className='bg-black/70 rounded-xl p-3 focus:text-black/70 font-semibold focus:outline-none focus:ring-2 focus:bg-gradient-to-r from-emerald-300 to-sky-400' placeholder='First Name' />
              <input type='lastname' name='lastName' required value={form.lastName} onChange={handleChange} className='bg-black/70 rounded-xl p-3 focus:text-black/70 font-semibold focus:outline-none focus:ring-2 focus:bg-gradient-to-r from-emerald-300 to-sky-400' placeholder='Last Name' />
              <input type='email' name='email' required value={form.email} onChange={handleChange} className='bg-black/70 rounded-xl p-3 focus:text-black/70 font-semibold focus:outline-none focus:ring-2 focus:bg-gradient-to-r from-emerald-300 to-sky-400' placeholder='Email' />
              <input type='phone' name='phone' required value={form.phone} onChange={handleChange} className='bg-black/70 rounded-xl p-3 focus:text-black/70 font-semibold focus:outline-none focus:ring-2 focus:bg-gradient-to-r from-emerald-300 to-sky-400' placeholder='Phone No.' />
            </div>
